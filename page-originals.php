            ...
            <div class="max-w-xl">
                ...
                Soluciones exclusivas que  
                 ...
                 <div class="flex flex-wrap gap-4 opacity-0 translate-y-8 animate-on-scroll" data-delay="400">
                    ...
                    <a href="<?php echo get_stylesheet_directory_uri(); ?>/public/pdf/consultoria.pdf" class="btn-descargar-pdf bg-white hover:bg-gray-100 text-primary px-8 py-4 rounded-xl transition-all duration-300 font-bold text-md shadow-lg hover:shadow-xl transform hover:scale-105 border-2 border-primary/20 flex items-center gap-3">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-gradient-to-b from-[#1a1d4a] to-[#2f3082] rounded-3xl overflow-hidden shadow-2xl opacity-0 translate-y-8 animate-on-scroll" data-delay="400">
                ...
                <div class="p-6 md:p-8">
                    ...
                    <a href="<?php echo get_stylesheet_directory_uri(); ?>/public/pdf/consultoria.pdf" class="btn-descargar-pdf bg-secondary hover:bg-secondary/80 text-white px-5 py-3 rounded-xl transition-all duration-300 font-bold text-sm shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center gap-2 inline-flex">
            ...
            <div class="bg-gradient-to-b from-[#1a1d4a] to-[#2f3082] rounded-3xl overflow-hidden shadow-2xl opacity-0 translate-y-8 animate-on-scroll" data-delay="800">
                ...
                <div class="p-6 md:p-8">
                    ...
                    <a href="<?php echo get_stylesheet_directory_uri(); ?>/public/pdf/capacitacion.pdf" class="btn-descargar-pdf bg-secondary hover:bg-secondary/80 text-white px-5 py-3 rounded-xl transition-all duration-300 font-bold text-sm shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center gap-2 inline-flex">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            <path d="M6 4v16a1 1 0 0 0 1.524 .852l13 -8a1 1 0 0 0 0 -1.704l-13 -8a1 1 0 0 0 -1.524 .852z" />
                        </svg>
