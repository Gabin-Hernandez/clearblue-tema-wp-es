        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="max-w-xl">
                ...
                <p class="text-gray-600 text-lg leading-relaxed opacity-0 translate-y-8 animate-on-scroll"
                    data-delay="300">
                    En Creatblue® México trabajamos con personas y empresas para crear equipos más fuertes, productivos
                    y preparados, a través de reclutamiento, capacitación, entrenamiento y consultoría.
                </p>
            </div>
            ...
            <div class="overflow-hidden opacity-0 scale-95 animate-on-scroll" data-delay="400">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/public/cont3.webp"
                    alt="Contacto a Creatblue México" class="w-full h-auto object-cover">
            </div>
        ...
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="border-2 border-gray-200 rounded-3xl p-8 md:p-10 hover:border-secondary/50 hover:shadow-lg transition-all duration-300 opacity-0 translate-y-8 animate-on-scroll"
                ...
                <p class="text-gray-600 text-base mb-8">
                    Si estás buscando nuevas oportunidades laborales, aquí puedes descubrir nuestra variedad de vacantes
                    desde posiciones operativas hasta directivas.
                </p>
                <a href="https://bolsadeempleo.creatblue.com/" target="_blank"
            ...
            <div class="border-2 border-gray-200 rounded-3xl p-8 md:p-10 hover:border-secondary/50 hover:shadow-lg transition-all duration-300 opacity-0 translate-y-8 animate-on-scroll"
                ...
                <p class="text-gray-600 text-base mb-8">
                    Ayudamos a las empresas a atraer talento, fortalecer equipos y mejorar su operación con soluciones
                    estratégicas a la medida.
                </p>
                <a href="#form_contact"
    ...
    <div class="container mx-auto px-6">
        <div class="grid lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2">
                ...
                <div id="mensaje-respuesta" class="hidden mb-6 p-4 rounded-lg"></div>

                <form id="contacto-form" action="#" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="solucion" id="solucion"
                            placeholder="Qué solución te interesa o requieres"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-secondary focus:border-secondary">
                    </div>
                    <div>
                        <label for="detalles" class="sr-only">Platícanos un poco más de los detalles a considerar en la
                            cotización</label>
                        <textarea name="detalles" id="detalles" rows="4"
                            placeholder="Platícanos un poco más de los detalles a considerar en la cotización"
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start">
                            <input id="marketing" name="marketing" type="checkbox"
                                class="h-4 w-4 text-secondary border-gray-300 rounded focus:ring-secondary mt-1">
                            <div class="ml-3 text-sm">
                                <label for="marketing" class="text-gray-600">Mantenme informado sobre noticias, eventos,
                                    promociones y actividad de marketing de Creatblue® México.</label>
                            </div>
                        </div>
                    </div>
                    <div>
                        <button type="submit" id="btn-submit"
                            class="w-full sm:w-auto bg-primary text-white px-8 py-3 rounded-lg font-bold hover:bg-primary/80 transition-colors flex justify-center items-center">
                            <span id="btn-text">Enviar</span>
                            <svg id="btn-loader" class="hidden animate-spin ml-2 h-5 w-5 text-white"
            ...
            <div class="lg:col-span-1">
                ...
                <p class="text-gray-600 mt-6 text-center lg:text-left">Creemos en el talento bien preparado y en
                    organizaciones que apuestan por el desarrollo continuo. ¡Hablemos!</p>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (contactoForm) {
            contactoForm.addEventListener('submit', function (e) {
                ...
                mensajeDiv.className = 'hidden mb-6 p-4 rounded-lg font-bold'; // Reset classes
                ...
                fetch('<?php echo admin_url("admin-ajax.php"); ?>', {
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            mensajeDiv.classList.add('bg-green-100', 'text-green-800', 'border-2', 'border-green-300');
                            mensajeDiv.innerHTML = data.data.mensaje;
                            contactoForm.reset();
                        } else {
                            mensajeDiv.classList.add('bg-red-100', 'text-red-800', 'border-2', 'border-red-300');
                            mensajeDiv.innerHTML = data.data.mensaje || 'Error al enviar el formulario.';
                        }
                    })
                    .catch(error => {
                        mensajeDiv.classList.remove('hidden');
                        mensajeDiv.classList.add('bg-red-100', 'text-red-800', 'border-2', 'border-red-300');
                        mensajeDiv.innerHTML = 'Error de conexión. Intente nuevamente más tarde.';
