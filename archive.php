<?php
/**
 * Template for displaying category and tag archives
 * 
 * @package Creatblue
 * @since 1.0.0
 */
        ...
        <div class="max-w-3xl mx-auto text-center">
            ...
            <?php elseif (is_author()) : ?>
                ...
                <div class="flex flex-col items-center mb-4">
                    <?php echo get_avatar(get_the_author_meta('ID'), 120, '', '', array('class' => 'rounded-full mb-4 border-4 border-white/20')); ?>
            ...
            <div class="mt-6 text-white/80">
                ...
                echo sprintf(
                    _n('Se encontró %s artículo', 'Se encontraron %s artículos', $total_posts, 'creatblue'),
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <nav class="mb-8 text-sm" aria-label="Breadcrumb">
                <ol class="flex items-center gap-2 text-gray-600">
                    <li>
                        <a href="<?php echo esc_url(home_url('/')); ?>" class="hover:text-secondary transition-colors">
                            Inicio
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="<?php echo esc_url(get_permalink(get_option('page_for_posts'))); ?>" class="hover:text-secondary transition-colors">
                            Blog
                        </a>
                    </li>
                    <li>
            ...
            <?php if (have_posts()) : ?>
                ...
                if ($pagination) :
                ?>
                    <nav class="flex justify-center" role="navigation" aria-label="Paginación del archivo">
                ...
                <div class="text-center py-16">
                    <div class="max-w-md mx-auto">
                        ...
                        <p class="text-gray-600 mb-8">
                            Lo sentimos, no hay artículos en esta sección.
                        </p>
