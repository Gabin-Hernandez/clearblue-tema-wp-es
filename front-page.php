        ...
        <div class="relative flex flex-col md:flex-row items-center justify-center md:justify-center gap-4">
            ...
            <div class="w-full md:w-auto lg:max-w-md xl:max-w-lg mt-8 md:mt-0 md:ml-8 lg:ml-12 z-20">
                ...
                <div class="space-y-3 md:space-y-4 z-20">
                    <!-- Entrenamiento -->
                    <a href="<?php echo esc_url(home_url('/entrenamiento')); ?>" class="block group transition-all duration-300 transform hover:-translate-y-1 opacity-0 translate-x-8 animate-on-scroll" data-delay="400">
                        <div class="bg-white border-2 border-gray-200 rounded-2xl p-2 md:p-3 flex items-center justify-between cursor-pointer group-hover:bg-primary group-hover:border-primary shadow-lg group-hover:shadow-2xl">
                    ...
                    <a href="<?php echo esc_url(home_url('/reclutamiento')); ?>" class="block group transition-all duration-300 transform hover:-translate-y-1 opacity-0 translate-x-8 animate-on-scroll" data-delay="600">
                        <div class="bg-white border-2 border-gray-200 rounded-2xl p-2 md:p-3 flex items-center justify-between cursor-pointer group-hover:bg-primary group-hover:border-primary shadow-lg group-hover:shadow-2xl">
                            <div class="flex items-center space-x-3 md:space-x-4">
                    ...
                    <!-- Capacitación -->
                    <a href="<?php echo esc_url(home_url('/capacitacion')); ?>" class="block group transition-all duration-300 transform hover:-translate-y-1 opacity-0 translate-x-8 animate-on-scroll" data-delay="800">
                        <div class="bg-white border-2 border-gray-200 rounded-2xl p-2 md:p-3 flex items-center justify-between cursor-pointer group-hover:bg-primary group-hover:border-primary shadow-lg group-hover:shadow-2xl">
                            <div class="flex items-center space-x-3 md:space-x-4">
                    ...
                    <!-- Consultoría -->
                    <a href="<?php echo esc_url(home_url('/consultoria')); ?>" class="block group transition-all duration-300 transform hover:-translate-y-1 opacity-0 translate-x-8 animate-on-scroll" data-delay="1000">
                        <div class="bg-white border-2 border-gray-200 rounded-2xl p-2 md:p-3 flex items-center justify-between cursor-pointer group-hover:bg-primary group-hover:border-primary shadow-lg group-hover:shadow-2xl">
                            <div class="flex items-center space-x-3 md:space-x-4">
                                <div class="w-10 h-10 md:w-12 md:h-12 bg-secondary/20 group-hover:bg-white rounded-xl flex items-center justify-center transition-colors duration-300">
                                    <svg class="w-5 h-5 md:w-6 md:h-6 text-primary group-hover:text-[#1e3a8a] transition-colors duration-300" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class="relative overflow-hidden bg-gradient-to-b from-[#2f3082] to-primary rounded-3xl shadow-2xl">
            <div class="flex flex-col md:flex-row items-center justify-between gap-8 p-10 md:p-12 relative z-10">
                ...
                <div class="text-white">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/public/camino_logo.webp" alt="Caminozum talent" class="mb-3 h-8 md:h-24 w-auto">
